...
class BTCCurveTests: XCTestCase {
    ...
    func testCompressedPublicKeys() {
        self.measure {
            ...
            for i in 0..<prvkeys.count {
                let publicKey = secp256k1.pubkeyForHexPrivateKey(prvkeys[i])
    ...
    func testUncompressedPublicKeys() {
        self.measure {
            let pubkeys = ["0459ddbf24ee3d88ce431dafb9f7a2b30cb5e5d811c4ae4347fa3c89fd1fcafbaaf21f14907b8d98a069e673217dcaa10141090d3536090e689f13ef7c87dbcfaf",
            ...
            for i in 0..<prvkeys.count {
                let publicKey = secp256k1.pubkeyForHexPrivateKey(prvkeys[i], compressed: false)
                XCTAssertEqual(publicKey, pubkeys[i])
            }
        }
    }
